...
```{r}
jpeg("figs/m1_postcheck.jpg", width = 350, height = 350)
plot(NULL,xlim=c(-40,60),ylim=c(3,5),
...
```{r}
jpeg("figs/m2_postcheck.jpg", width = 350, height = 350)
plot(NULL,xlim=c(-40,60),ylim=c(3,5),
     xlab="launch angle", ylab="exit speed")
for(i in 1:50){
...
```{r}
jpeg("figs/m3_postcheck.jpg", width = 350, height = 350)
plot(NULL,xlim=c(-40,60),ylim=c(3,5),
     xlab="launch angle", ylab="exit speed")
for(i in 1:50){
...
```{r}
jpeg("figs/m4_postcheck.jpg", width = 350, height = 350)
plot(NULL,xlim=c(-40,60),ylim=c(3,5),
     xlab="launch angle", ylab="exit speed")
for(i in 1:50){
...
```{r}
jpeg("figs/hitter393.jpg", width = 350, height = 350)
